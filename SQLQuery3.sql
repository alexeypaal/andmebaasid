...
VALUES ('detektiiv', 'dokumentaalfilm'), ('huvi', 'värviline'), ('õudus', 'väga hirmutav'), ('Ilukirjandus', 'Põnev'), ('Cartoon', 'Põnev')
SELECT * FROM zanr
...
---Tabeli loomine piletiMüük.
CREATE TABLE piletiMüük(
	piletiMyykId int Primary Key identity(1,1),
	kogus int,
	kinokavaId int)
INSERT INTO piletiMüük (kogus, kinokavaId)
VALUES (11, 3)
SELECT * FROM piletiMüük
